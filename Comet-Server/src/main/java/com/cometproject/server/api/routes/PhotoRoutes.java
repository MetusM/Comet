...
public class PhotoRoutes {
    public static Object purchase(Request req, Response res) {
        ...
        if(currentTime < (client.getPlayer().getData().getLastPhotoTaken() + 10000)) {
        ...
        if(playerItem == null) {
            result.put("error", "Cannot find ItemID: " + itemId + " for player ID: " + playerId);
            return result;
        }
